...
const AttendanceSchema = new mongoose.Schema(
  {
    ...
    date: { type: Date, required: true }, // Date field for daily records
    checkIn: { type: Date },
    checkOut: { type: Date },
    status: {
      type: String,
    ...
    workingHours: { type: Number, default: 0 }, // Daily working hours
  },
  { timestamps: true }
);

// Create compound unique index for employeeId + date
...
export const EmployeeLogin = loginDB.model(
  "EmployeeLogin",
  EmployeeLoginSchema,
  "employeeLogins"
);
...
export const CentreLogin = loginDB.model(
  "CentreLogin",
  CentreLoginSchema,
  "centreLogins"
);

export const AdminLogin = loginDB.model(
  "AdminLogin",
  AdminLoginSchema,
  "adminLogins"
);
...
export const Attendance = employeeDB.model(
  "Attendance",
  AttendanceSchema,
  "attendance"
);
