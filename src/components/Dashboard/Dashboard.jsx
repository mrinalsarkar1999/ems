...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch centers
        const centersResponse = await fetch(getApiUrl("/api/centers"), {
          headers: {
  ...
  const handleApprove = async () => {
    ...
    try {
      const response = await fetch(
        getApiUrl(`/api/employees/${selectedEmployee._id}/status`),
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const employeesForCentre = employees.filter(
    (emp) =>
      (emp.centreCode || emp.centerCode || "").toLowerCase() ===
      userCentreCode.toLowerCase()
  );
      ...
      <div style={{ flex: 1 }}>
        ...
        {user && (user.centreName || user.centerName || userCentreCode) && (
          ...
          >
            ...
            >
              Center Code:{" "}
              <span style={{ color: "#1976d2" }}>{userCentreCode}</span>
            </div>
          </div>
        )}
        <div className="dashboard-container">
          ...
          <div className="stats-container">
            ...
            <div className="stat-card">
              ...
              <div className="stat-value">{employeesForCentre.length}</div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-value">
                {
                  employeesForCentre.filter((emp) => emp.status === "Approved")
                    .length
                }
              </div>
            ...
            <div className="stat-card">
              ...
              <div className="stat-value">
                {
                  employeesForCentre.filter((emp) => emp.status === "Pending")
                    .length
                }
              </div>
            ...
            <div className="card-content">
              ...
              <div className="table-container">
                <table className="table">
                  ...
                  <tbody>
                    {(centreCodeFilter
                      ? employeesForCentre.filter((emp) =>
                          (emp.centreCode || emp.centerCode || "")
                            .toLowerCase()
                            .includes(centreCodeFilter.toLowerCase())
                        )
                      : employeesForCentre
                    ).map((employee) => (
                      <tr key={employee._id}>
