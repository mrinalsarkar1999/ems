...
function AdminDashboard() {
  ...
  const handleEditCenterSave = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(
        `http://localhost:5000/api/centers/${editCenter._id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleApproveCenter = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(
        `http://localhost:5000/api/centers/${editCenter._id}/status`,
        {
          method: "PUT",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      <div className="card">
        <div className="card-content">
          ...
          <p style={{ margin: "16px 0" }}>
            This is your admin dashboard. Here you can manage the application,
            view statistics, and perform admin-specific actions.
          </p>
