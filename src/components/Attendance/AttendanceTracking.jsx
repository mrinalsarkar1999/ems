...
function AttendanceTracking() {
  ...
  const todayRecords = attendanceRecords.filter(
    (r) => r.date && r.date.slice(0, 10) === today
  );
  ...
  const demoRecords = [
    ...
    },
    {
      employeeId: "EMP002",
      name: "Bob Johnson",
      date: today + "T09:15:00Z",
      checkIn: today + "T09:15:00Z",
      checkOut: today + "T18:00:00Z",
      status: "Late",
      workingHours: 8.75,
    },
    ...
    },
    {
      ...
      checkIn: today + "T09:05:00Z",
      checkOut: today + "T13:00:00Z",
      status: "Half Day",
      workingHours: 4,
    },
    {
  ...
  const leave = recordsToShow.filter(
